    ...
    <>
      ...
      <div className="lg:hidden relative" ref={menuRef}>
        <button
          ...
          className="rounded-lg bg-zinc-100 dark:bg-zinc-800 p-2 text-zinc-700 dark:text-zinc-300 transition-colors hover:bg-zinc-200 dark:hover:bg-zinc-700 cursor-pointer relative"
        ...
        {isOpen && (
          <div className="absolute left-0 mt-2 w-64 rounded-lg bg-white dark:bg-zinc-800 shadow-lg ring-1 ring-black ring-opacity-5 dark:ring-zinc-700 overflow-hidden z-50 max-h-80 overflow-y-auto">
